...
// aws dynamodb put-item --table-name tf-bookings-table --item '{"id": {"S": "e0a71c6a-0f12-4290-9eb1-c00060cf7d65"}, "guestDetails": {"S": "Birthday weekend"}, "houses":  {"SS": ["Laarse", "Rondavel"]}}' --profile=jabulani
